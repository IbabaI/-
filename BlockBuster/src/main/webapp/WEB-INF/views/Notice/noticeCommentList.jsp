...
<body>
	...
	<div class="card-body col-sm-12" style="opacity:0.8; padding: 0px;">
		<h3 class="border-bottom pb-2 mb-0">댓글목록</h3>
	...
	<table>
		...
		<c:forEach var="list" items="${noticeCommentList}" varStatus="status">
			
			<tr id="cno1${status.index}" class="border-top pb-2 mb-0">
				
				<td>${list.nickName}&emsp;|&emsp;${list.nc_date}</td>
				<td><input type="hidden" value="${list.n_no}"></td>
				<td><input type="hidden" id="cnoNo${status.index}" value="${list.nc_no}"></td>
